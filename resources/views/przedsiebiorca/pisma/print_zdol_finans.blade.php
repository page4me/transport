  ...
  <div class="container" style="font-size: 14px;font-family: Arial;width:900px;">
     ...
     <strong>{{$przedsiebiorca->nazwa_firmy}}<br/>{{$przedsiebiorca->adres}}<br />{{$przedsiebiorca->kod_p}} {{$przedsiebiorca->miejscowosc}}</strong>
  	 ...
  	 <div>
  	  ...
  	  <ul>
  	   <li>
		<p>1) dokumenty potwierdzające spełnienie warunków, o których mowa w art. 7 rozporządzenia (WE) nr 1071/2009 związane z
  	 ...
  	 <div>
           <p class="text-justify">W drodze odstępstwa właściwy organ może zgodzić się lub wymagać, aby przedsiębiorca wykazał swoją zdolność
           finansową za pomocą zabezpieczenia, takiego jak gwarancja bankowa lub ubezpieczenie, w tym ubezpieczenie
           odpowiedzialności zawodowej z jednego lub kilku banków lub innych instytucji finansowych, w tym przedsiębiorstw
           ubezpieczeniowych, składających solidarną gwarancję za przedsiębiorstwo na kwoty określone przy posiadaniu pojazdów
